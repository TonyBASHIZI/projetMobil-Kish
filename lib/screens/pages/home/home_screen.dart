...
class _HomeScreenState extends State<HomeScreen> {
  final List<String> images = ['images/products/blazer1.jpeg','images/products/blazer1.jpeg','images/products/blazer1.jpeg', 'images/products/blazer1.jpeg','images/products/blazer1.jpeg','images/products/blazer1.jpeg','images/products/blazer1.jpeg'];
        ...
        slivers: <Widget>[
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              title: Text('Zakuuza'),
              background: Image.asset('images/shop5.jpg', fit: BoxFit.cover),
            ),
            actions: <Widget>[
              IconButton(
      ...
      child: Container(
        child: Swiper(
          ...
          itemBuilder: (BuildContext context,int index){
            return new Image.asset(images[index],fit: BoxFit.cover,height: 150);
          },
          itemCount: 4,
